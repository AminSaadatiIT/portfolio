...
window.AIGenerator = (function() {
  ...
  var fa = {
    ...
    wifi: [
      "پیاده‌سازی شبه بیسیم با پوشش سیگنال.",
      "طراحی و پیکربندی شبه با استاندارد استاندارد.",
      "پیاده‌سازی شبه با پرتکل دسترسی است."
    ],
    voip: [
      "راه‌اندازی سیستم تلفن VoIP با IP PBX.",
      "پیکربندی سیستم تلفن صنعتی.",
      "صدای صورتی و اطلاعات خودکار."
    ],
    firealarm: [
      "سیستم اعلام حریق خودکار و اطلاع خودکار.",
      "سنسورهای دود اظظاری و شارچ دود.",
      "اتصال به آتشیشنجانی و مانیتورینگ مرکززی."
    ],
    ups: [
      "سیستم UPS برقی برای تعمین برق.",
      "طراحی سیستم برق اضطراری و جنرنهای.",
      "مانیتورینگ ولتاج برق و تغذیه."
    ],
    cloud: [
      "میگرانشی زیرساخت در ابروع کلاد.",
      "پیکربندی سرورس ابروع کلاد و زیرساخت هیبرید.",
      "تنظیم زیرساخت برای میزان ابروع کلاد."
    ],
    software: [
      "توصیه نرم‌افزار ساختاری برای مدیریت پروژه.",
      "پیکربندی سیستم هشتاری و اطلاع‌رسانی.",
      "توصیه اطلاعات محصوص برای سازمان."
    ],
